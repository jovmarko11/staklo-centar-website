...
export const seo = {
  ...
  title: "Zamena auto-stakla i šoferšajbni Beograd | Staklo Centar",
  // Opis ispod naslova u Google rezultatu (do ~155 znakova).
  description:
    "Zamena i popravka šoferšajbni, bočnih i zadnjih stakala za sve marke vozila u Beogradu. Rad sa osiguranjem, dolazak na adresu, garancija na ugradnju.",
